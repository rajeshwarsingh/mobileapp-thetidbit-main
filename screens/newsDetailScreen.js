  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: Colors.white }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <Image source={require("../assets/image/cricketer.png")} />
        ...
        >
          ...
          >
            <Image source={require("../assets/image/mainIcon.png")} />
            <View
              style={{
                ...Default.shadow,
                backgroundColor: Colors.white,
          ...
          >
            <Text style={{ ...Fonts.SemiBold18Black }}>
              Team India won the fourth consecutive ODI series defeating
              Zimbabwe by 5 wickets in the second match
            </Text>
            <View
              style={{
                flexDirection: isRtl ? "row-reverse" : "row",
